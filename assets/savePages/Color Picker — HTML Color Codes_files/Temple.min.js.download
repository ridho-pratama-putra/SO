...
banner.setupDynamic = function() {
    this.animationSources = [ "js/300x250_intro.js" ];
    this.animationLibs = [ "lib_300x250_intro" ];
    this.animationSprites = [ "img/300x250_intro_atlas_.png" ];
    ...
    this.animationSources.push("js/300x250_outro.js");
    this.animationLibs.push("lib_300x250_outro");
    this.animationSprites.push("img/300x250_outro_atlas_.png");
...
banner.setupCreateJs = function() {
    this.animations = [];
    console.log(this.createjsModule.lib);
